...
public class ComponentVillageField extends ComponentVillage
{
    ...
    public ComponentVillageField(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
        ...
        this.cropTypeA = this.getCrop(par3Random);
        this.cropTypeB = this.getCrop(par3Random);
        this.cropTypeC = this.getCrop(par3Random);
        this.cropTypeD = this.getCrop(par3Random);
    }

    /**
     * Return a crop type to be planted on this field.
     */
    private int getCrop(Random par1Random)
    {
