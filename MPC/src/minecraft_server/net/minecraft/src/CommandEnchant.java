...
public class CommandEnchant extends CommandBase
{
                        ...
                        if (var8 != null)
                        {
                            for (int var9 = 0; var9 < var8.tagCount(); ++var9)
                            {
                                ...
                                if (Enchantment.enchantmentsList[var10] != null)
                                {
                                    ...
                                    {
                                        notifyAdmins(par1ICommandSender, "commands.enchant.cantCombine", new Object[] {var7.func_77316_c(var5), var11.func_77316_c(((NBTTagCompound)var8.tagAt(var9)).getShort("lvl"))});
                                        return;
                                    }
                                }
                            }
    ...
    {
        return par2ArrayOfStr.length == 1 ? getListOfStringsMatchingLastWord(par2ArrayOfStr, this.func_90022_d()) : null;
    }
