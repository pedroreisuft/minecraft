...
public class WorldInfo
{
    ...
    public WorldInfo(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.totalWorldTime = par1NBTTagCompound.getLong("Time");
        ...
        {
            this.worldTime = this.totalWorldTime;
        }
    ...
    public WorldInfo(WorldInfo par1WorldInfo)
    {
        ...
        this.totalWorldTime = par1WorldInfo.totalWorldTime;
    ...
    private void updateTagCompound(NBTTagCompound par1NBTTagCompound, NBTTagCompound par2NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setLong("Time", this.totalWorldTime);
    ...
    {
        return par0WorldInfo.totalWorldTime;
    }
