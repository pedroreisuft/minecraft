...
public abstract class EntityLiving extends Entity {
      ...
      if(this.func_85032_ar()) {
         ...
         if(this.field_70734_aK <= 0) {
            ...
            if((p_70097_1_ == DamageSource.field_82728_o || p_70097_1_ == DamageSource.field_82729_p) && this.func_71124_b(4) != null) {
               p_70097_2_ = (int)((float)p_70097_2_ * 0.55F);
            }
   ...
   public void func_70636_d() {
      ...
      if(!this.field_70170_p.field_72995_K && this.field_82172_bs && !this.field_70729_aU && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
         ...
         while(var12.hasNext()) {
            ...
            if(!var4.field_70128_L && var4.field_70294_a != null) {
               ItemStack var13 = var4.field_70294_a;
   ...
   protected void func_82162_bC() {
      if(this.func_70694_bm() != null && this.field_70146_Z.nextFloat() < field_82177_b[this.field_70170_p.field_73013_u]) {
         EnchantmentHelper.func_77504_a(this.field_70146_Z, this.func_70694_bm(), 5);
      }
