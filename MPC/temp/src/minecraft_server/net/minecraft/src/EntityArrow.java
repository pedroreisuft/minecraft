               ...
               if(var4.field_72308_g.func_70097_a(var21, var23)) {
                  if(var4.field_72308_g instanceof EntityLiving) {
                     ...
                     if(this.field_70256_ap > 0) {
                        ...
                        if(var25 > 0.0F) {
                           var4.field_72308_g.func_70024_g(this.field_70159_w * (double)this.field_70256_ap * 0.6000000238418579D / (double)var25, 0.1D, this.field_70179_y * (double)this.field_70256_ap * 0.6000000238418579D / (double)var25);
                        }
                     }
                  }
