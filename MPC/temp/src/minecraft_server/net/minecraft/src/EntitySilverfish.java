...
public class EntitySilverfish extends EntityMob {
   ...
   protected void func_70785_a(Entity p_70785_1_, float p_70785_2_) {
      if(this.field_70724_aR <= 0 && p_70785_2_ < 1.2F && p_70785_1_.field_70121_D.field_72337_e > this.field_70121_D.field_72338_b && p_70785_1_.field_70121_D.field_72338_b < this.field_70121_D.field_72337_e) {
         ...
         p_70785_1_.func_70097_a(DamageSource.func_76358_a(this), this.func_82193_c(p_70785_1_));
      }
      ...
      if(!this.field_70170_p.field_72995_K) {
                  ...
                  for(int var6 = 0; !var4 && var6 <= 10 && var6 >= -10; var6 = var6 <= 0?1 - var6:0 - var6) {
                     for(int var7 = 0; !var4 && var7 <= 10 && var7 >= -10; var7 = var7 <= 0?1 - var7:0 - var7) {
                        ...
                        if(var8 == Block.field_72006_bl.field_71990_ca) {
                           this.field_70170_p.func_72926_e(2001, var1 + var6, var2 + var5, var3 + var7, Block.field_72006_bl.field_71990_ca + (this.field_70170_p.func_72805_g(var1 + var6, var2 + var5, var3 + var7) << 12));
                           this.field_70170_p.func_72859_e(var1 + var6, var2 + var5, var3 + var7, 0);
         ...
         if(this.field_70789_a == null && !this.func_70781_l()) {
            ...
            if(BlockSilverfish.func_72154_e(var5)) {
               this.field_70170_p.func_72832_d(var1 + Facing.field_71586_b[var9], var2 + Facing.field_71587_c[var9], var3 + Facing.field_71585_d[var9], Block.field_72006_bl.field_71990_ca, BlockSilverfish.func_72153_f(var5));
               this.func_70656_aK();
               this.func_70106_y();
            } else {
               this.func_70779_j();
