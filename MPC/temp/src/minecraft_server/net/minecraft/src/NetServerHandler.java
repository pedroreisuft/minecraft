...
public class NetServerHandler extends NetHandler {
   ...
   public void func_72510_a(Packet14BlockDig p_72510_1_) {
      ...
      if(p_72510_1_.field_73342_e == 4) {
         this.field_72574_e.func_71040_bB();
      } else if(p_72510_1_.field_73342_e == 5) {
         this.field_72574_e.func_71034_by();
      } else {
         boolean var3 = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72376_i().isEmpty() || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || this.field_72573_d.func_71264_H();
         boolean var4 = false;
         ...
         int var5 = p_72510_1_.field_73345_a;
         int var6 = p_72510_1_.field_73343_b;
         int var7 = p_72510_1_.field_73344_c;
         if(var4) {
            double var8 = this.field_72574_e.field_70165_t - ((double)var5 + 0.5D);
            double var10 = this.field_72574_e.field_70163_u - ((double)var6 + 0.5D) + 1.5D;
            double var12 = this.field_72574_e.field_70161_v - ((double)var7 + 0.5D);
            double var14 = var8 * var8 + var10 * var10 + var12 * var12;
            if(var14 > 36.0D) {
               return;
            }

            if(var6 >= this.field_72573_d.func_71207_Z()) {
               return;
            }
         }

         ChunkCoordinates var19 = var2.func_72861_E();
         int var9 = MathHelper.func_76130_a(var5 - var19.field_71574_a);
         int var20 = MathHelper.func_76130_a(var7 - var19.field_71573_c);
         if(var9 > var20) {
            var20 = var9;
         }

         if(p_72510_1_.field_73342_e == 0) {
            if(var20 <= this.field_72573_d.func_82357_ak() && !var3) {
               this.field_72574_e.field_71135_a.func_72567_b(new Packet53BlockChange(var5, var6, var7, var2));
            } else {
               this.field_72574_e.field_71134_c.func_73074_a(var5, var6, var7, p_72510_1_.field_73341_d);
            }
         } else if(p_72510_1_.field_73342_e == 2) {
            this.field_72574_e.field_71134_c.func_73082_a(var5, var6, var7);
            if(var2.func_72798_a(var5, var6, var7) != 0) {
               this.field_72574_e.field_71135_a.func_72567_b(new Packet53BlockChange(var5, var6, var7, var2));
            }
         } else if(p_72510_1_.field_73342_e == 1) {
            this.field_72574_e.field_71134_c.func_73073_c(var5, var6, var7);
            if(var2.func_72798_a(var5, var6, var7) != 0) {
               this.field_72574_e.field_71135_a.func_72567_b(new Packet53BlockChange(var5, var6, var7, var2));
            }
         } else if(p_72510_1_.field_73342_e == 3) {
            double var11 = this.field_72574_e.field_70165_t - ((double)var5 + 0.5D);
            double var13 = this.field_72574_e.field_70163_u - ((double)var6 + 0.5D);
            double var15 = this.field_72574_e.field_70161_v - ((double)var7 + 0.5D);
   ...
   public void func_72472_a(Packet15Place p_72472_1_) {
      ...
      boolean var9 = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72376_i().isEmpty() || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || this.field_72573_d.func_71264_H();
      if(p_72472_1_.func_73401_h() == 255) {
         ...
         ChunkCoordinates var10 = var2.func_72861_E();
         int var11 = MathHelper.func_76130_a(var5 - var10.field_71574_a);
         int var12 = MathHelper.func_76130_a(var7 - var10.field_71573_c);
         if(var11 > var12) {
            var12 = var11;
         }

         if(this.field_72587_r && this.field_72574_e.func_70092_e((double)var5 + 0.5D, (double)var6 + 0.5D, (double)var7 + 0.5D) < 64.0D && (var12 > this.field_72573_d.func_82357_ak() || var9)) {
      ...
      if(var3 == null || var3.func_77988_m() == 0) {
         ...
         Slot var13 = this.field_72574_e.field_71070_bA.func_75147_a(this.field_72574_e.field_71071_by, this.field_72574_e.field_71071_by.field_70461_c);
         ...
         if(!ItemStack.func_77989_b(this.field_72574_e.field_71071_by.func_70448_g(), p_72472_1_.func_73405_i())) {
            this.func_72567_b(new Packet103SetSlot(this.field_72574_e.field_71070_bA.field_75152_c, var13.field_75222_d, this.field_72574_e.field_71071_by.func_70448_g()));
         }
      }
         ...
         if("MC|TrSel".equals(p_72501_1_.field_73630_a)) {
            try {
               ...
               if(var15 instanceof ContainerMerchant) {
                  ((ContainerMerchant)var15).func_75175_c(var14);
               }
