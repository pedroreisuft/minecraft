...
public class GuiRepair extends GuiContainer implements ICrafting {
   ...
   protected void func_74185_a(float p_74185_1_, int p_74185_2_, int p_74185_3_) {
      int var4 = this.field_73882_e.field_71446_o.func_78341_b("/gui/repair.png");
      ...
      this.func_73729_b(var5 + 59, var6 + 20, 0, this.field_74195_c + (this.field_82327_o.func_75139_a(0).func_75216_d()?0:16), 110, 16);
      if((this.field_82327_o.func_75139_a(0).func_75216_d() || this.field_82327_o.func_75139_a(1).func_75216_d()) && !this.field_82327_o.func_75139_a(2).func_75216_d()) {
         this.func_73729_b(var5 + 99, var6 + 45, this.field_74194_b, 0, 28, 21);
      }
