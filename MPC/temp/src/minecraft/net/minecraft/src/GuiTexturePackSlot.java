...
class GuiTexturePackSlot extends GuiSlot {
   ...
   protected void func_77213_a(int p_77213_1_, boolean p_77213_2_) {
      ...
      try {
         ...
         GuiTexturePacks.func_73962_f(this.field_77270_a).field_71418_C.func_77294_a((ITexturePack)var3.get(0));
   ...
   protected void func_77214_a(int p_77214_1_, int p_77214_2_, int p_77214_3_, int p_77214_4_, Tessellator p_77214_5_) {
      ITexturePack var6 = (ITexturePack)GuiTexturePacks.func_73953_j(this.field_77270_a).field_71418_C.func_77293_d().get(p_77214_1_);
