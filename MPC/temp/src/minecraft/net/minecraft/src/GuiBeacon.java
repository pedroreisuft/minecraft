...
import net.minecraft.src.GuiBeaconButtonCancel;
import net.minecraft.src.GuiBeaconButtonConfirm;
import net.minecraft.src.GuiBeaconButtonPower;
...
public class GuiBeacon extends GuiContainer {
   ...
   protected void func_74185_a(float p_74185_1_, int p_74185_2_, int p_74185_3_) {
      int var4 = this.field_73882_e.field_71446_o.func_78341_b("/gui/beacon.png");
      ...
      field_74196_a.func_82406_b(this.field_73886_k, this.field_73882_e.field_71446_o, new ItemStack(Item.field_77817_bH), var5 + 42, var6 + 109);
      field_74196_a.func_82406_b(this.field_73886_k, this.field_73882_e.field_71446_o, new ItemStack(Item.field_77702_n), var5 + 42 + 22, var6 + 109);
      field_74196_a.func_82406_b(this.field_73886_k, this.field_73882_e.field_71446_o, new ItemStack(Item.field_77717_p), var5 + 42 + 44, var6 + 109);
      field_74196_a.func_82406_b(this.field_73886_k, this.field_73882_e.field_71446_o, new ItemStack(Item.field_77703_o), var5 + 42 + 66, var6 + 109);
