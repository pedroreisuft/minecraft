...
public class CraftingManager {
   ...
   private CraftingManager() {
      ...
      this.func_77595_a(new ItemStack(Block.field_82515_ce, 6, 0), new Object[]{"###", "###", Character.valueOf('#'), Block.field_71978_w});
      this.func_77595_a(new ItemStack(Block.field_82515_ce, 6, 1), new Object[]{"###", "###", Character.valueOf('#'), Block.field_72087_ao});
      ...
      this.func_77595_a(new ItemStack(Item.field_82796_bJ, 1), new Object[]{"# #", " # ", Character.valueOf('#'), Item.field_77772_aH});
      ...
      this.func_77595_a(new ItemStack(Item.field_82793_bR, 1), new Object[]{"# ", " X", Character.valueOf('#'), Item.field_77749_aR, Character.valueOf('X'), Item.field_82797_bK});
      ...
      this.func_77595_a(new ItemStack(Item.field_82802_bI, 1), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Item.field_77669_D, Character.valueOf('X'), Item.field_77770_aF});
      ...
      this.func_77595_a(new ItemStack(Item.field_82798_bP, 1, 0), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Item.field_77733_bq, Character.valueOf('X'), Item.field_82797_bK});
      ...
      this.func_77595_a(new ItemStack(Item.field_82801_bO, 1), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Item.field_77759_aK, Character.valueOf('X'), Item.field_77750_aQ});
      this.func_77595_a(new ItemStack(Block.field_72034_aR, 1), new Object[]{"#", Character.valueOf('#'), Block.field_71981_t});
      this.func_77595_a(new ItemStack(Block.field_82511_ci, 1), new Object[]{"#", Character.valueOf('#'), Block.field_71988_x});
      ...
      this.func_77595_a(new ItemStack(Block.field_82510_ck, 1), new Object[]{"III", " i ", "iii", Character.valueOf('I'), Block.field_72083_ai, Character.valueOf('i'), Item.field_77703_o});
   ...
   void func_77595_a(ItemStack p_77595_1_, Object ... p_77595_2_) {
      ...
      if(p_77595_2_[var4] instanceof String[]) {
         ...
         while(p_77595_2_[var4] instanceof String) {
            String var11 = (String)p_77595_2_[var4++];
            ++var6;
            var5 = var11.length();
            var3 = var3 + var11;
         }
      ...
      HashMap var12;
      for(var12 = new HashMap(); var4 < p_77595_2_.length; var4 += 2) {
         Character var13 = (Character)p_77595_2_[var4];
         ItemStack var14 = null;
         if(p_77595_2_[var4 + 1] instanceof Item) {
            var14 = new ItemStack((Item)p_77595_2_[var4 + 1]);
         } else if(p_77595_2_[var4 + 1] instanceof Block) {
            var14 = new ItemStack((Block)p_77595_2_[var4 + 1], 1, -1);
         } else if(p_77595_2_[var4 + 1] instanceof ItemStack) {
            var14 = (ItemStack)p_77595_2_[var4 + 1];
         }
