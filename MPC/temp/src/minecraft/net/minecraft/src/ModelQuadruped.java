...
public class ModelQuadruped extends ModelBase {
   ...
   public ModelQuadruped(int p_i3129_1_, float p_i3129_2_) {
      this.field_78150_a.func_78790_a(-4.0F, -4.0F, -8.0F, 8, 8, 8, p_i3129_2_);
      this.field_78150_a.func_78793_a(0.0F, (float)(18 - p_i3129_1_), -6.0F);
      this.field_78148_b = new ModelRenderer(this, 28, 8);
      this.field_78148_b.func_78790_a(-5.0F, -10.0F, -7.0F, 10, 16, 8, p_i3129_2_);
      this.field_78148_b.func_78793_a(0.0F, (float)(17 - p_i3129_1_), 2.0F);
      this.field_78149_c = new ModelRenderer(this, 0, 16);
      this.field_78149_c.func_78790_a(-2.0F, 0.0F, -2.0F, 4, p_i3129_1_, 4, p_i3129_2_);
      this.field_78149_c.func_78793_a(-3.0F, (float)(24 - p_i3129_1_), 7.0F);
      this.field_78146_d = new ModelRenderer(this, 0, 16);
      this.field_78146_d.func_78790_a(-2.0F, 0.0F, -2.0F, 4, p_i3129_1_, 4, p_i3129_2_);
      this.field_78146_d.func_78793_a(3.0F, (float)(24 - p_i3129_1_), 7.0F);
      this.field_78147_e = new ModelRenderer(this, 0, 16);
      this.field_78147_e.func_78790_a(-2.0F, 0.0F, -2.0F, 4, p_i3129_1_, 4, p_i3129_2_);
      this.field_78147_e.func_78793_a(-3.0F, (float)(24 - p_i3129_1_), -5.0F);
      this.field_78144_f = new ModelRenderer(this, 0, 16);
      this.field_78144_f.func_78790_a(-2.0F, 0.0F, -2.0F, 4, p_i3129_1_, 4, p_i3129_2_);
      this.field_78144_f.func_78793_a(3.0F, (float)(24 - p_i3129_1_), -5.0F);
   }
