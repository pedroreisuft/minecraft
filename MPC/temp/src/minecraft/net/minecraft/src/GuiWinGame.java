...
public class GuiWinGame extends GuiScreen {
      ...
      if(this.field_73988_b == null) {
         ...
         try {
            ...
            while((var1 = var4.readLine()) != null) {
               String var7;
               String var8;
               for(var1 = var1.replaceAll("PLAYERNAME", this.field_73882_e.field_71449_j.field_74286_b); var1.contains(var2); var1 = var7 + "\u00a7f\u00a7k" + "XXXXXXXX".substring(0, var5.nextInt(4) + 3) + var8) {
   ...
   private void func_73986_b(int p_73986_1_, int p_73986_2_, float p_73986_3_) {
      ...
      GL11.glBindTexture(3553, this.field_73882_e.field_71446_o.func_78341_b("%blur%/gui/background.png"));
      var4.func_78382_b();
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      GL11.glPopMatrix();
      GL11.glBindTexture(3553, this.field_73882_e.field_71446_o.func_78341_b("%blur%/misc/vignette.png"));
      GL11.glEnable(3042);
