...
import net.minecraft.src.CallableLastTickedParticle;
...
public class EffectRenderer {
   ...
   public void func_78868_a() {
      for(int var1 = 0; var1 < 4; ++var1) {
         ...
         try {
            for(int var3 = 0; var3 < this.field_78876_b[var1].size(); ++var3) {
               var2 = (EntityFX)this.field_78876_b[var1].get(var3);
               var2.func_70071_h_();
               if(var2.field_70128_L) {
                  this.field_78876_b[var1].remove(var3--);
               }
            }
            ...
            var5.func_71500_a("Last ticked particle", new CallableLastTickedParticle(this, var2));
            var5.func_71507_a("Texture index", Integer.valueOf(var1));
   ...
   public void func_78874_a(Entity p_78874_1_, float p_78874_2_) {
      ...
      for(int var8 = 0; var8 < 3; ++var8) {
         if(!this.field_78876_b[var8].isEmpty()) {
            int var9 = 0;
            if(var8 == 0) {
               var9 = this.field_78877_c.func_78341_b("/particles.png");
            }

            if(var8 == 1) {
               var9 = this.field_78877_c.func_78341_b("/terrain.png");
            }

            if(var8 == 2) {
               var9 = this.field_78877_c.func_78341_b("/gui/items.png");
            }
