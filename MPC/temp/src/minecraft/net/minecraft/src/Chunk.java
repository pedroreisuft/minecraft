...
public class Chunk {
            ...
            for(int var8 = 0; var8 < var5; ++var8) {
               ...
               if(var9 != 0) {
                  ...
                  if(this.field_76652_q[var10] == null) {
                     this.field_76652_q[var10] = new ExtendedBlockStorage(var10 << 4);
                  }
   ...
   public boolean func_76592_a(int p_76592_1_, int p_76592_2_, int p_76592_3_, int p_76592_4_, int p_76592_5_) {
      ...
      if(var8 == p_76592_4_ && var9 == p_76592_5_) {
         ...
         if(var10 == null) {
            ...
            var10 = this.field_76652_q[p_76592_2_ >> 4] = new ExtendedBlockStorage(p_76592_2_ >> 4 << 4);
   ...
   public int func_76614_a(EnumSkyBlock p_76614_1_, int p_76614_2_, int p_76614_3_, int p_76614_4_) {
      ...
      return var5 == null?(this.func_76619_d(p_76614_2_, p_76614_3_, p_76614_4_)?p_76614_1_.field_77198_c:0):(p_76614_1_ == EnumSkyBlock.Sky?var5.func_76670_c(p_76614_2_, p_76614_3_ & 15, p_76614_4_):(p_76614_1_ == EnumSkyBlock.Block?var5.func_76674_d(p_76614_2_, p_76614_3_ & 15, p_76614_4_):p_76614_1_.field_77198_c));
   }
   ...
   public void func_76607_a(byte[] p_76607_1_, int p_76607_2_, int p_76607_3_, boolean p_76607_4_) {
      ...
      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if((p_76607_2_ & 1 << var6) != 0) {
            if(this.field_76652_q[var6] == null) {
               this.field_76652_q[var6] = new ExtendedBlockStorage(var6 << 4);
            }

            byte[] var7 = this.field_76652_q[var6].func_76658_g();
            System.arraycopy(p_76607_1_, var5, var7, 0, var7.length);
            var5 += var7.length;
         } else if(p_76607_4_ && this.field_76652_q[var6] != null) {
      ...
      NibbleArray var8;
      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if((p_76607_2_ & 1 << var6) != 0 && this.field_76652_q[var6] != null) {
            var8 = this.field_76652_q[var6].func_76669_j();
            System.arraycopy(p_76607_1_, var5, var8.field_76585_a, 0, var8.field_76585_a.length);
            var5 += var8.field_76585_a.length;
         }
      }

      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if((p_76607_2_ & 1 << var6) != 0 && this.field_76652_q[var6] != null) {
            var8 = this.field_76652_q[var6].func_76661_k();
            System.arraycopy(p_76607_1_, var5, var8.field_76585_a, 0, var8.field_76585_a.length);
            var5 += var8.field_76585_a.length;
         }
      }
      ...
      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if((p_76607_2_ & 1 << var6) != 0 && this.field_76652_q[var6] != null) {
            var8 = this.field_76652_q[var6].func_76671_l();
            System.arraycopy(p_76607_1_, var5, var8.field_76585_a, 0, var8.field_76585_a.length);
            var5 += var8.field_76585_a.length;
         }
      }
      ...
      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if((p_76607_3_ & 1 << var6) != 0) {
            if(this.field_76652_q[var6] == null) {
               var5 += 2048;
            } else {
               var8 = this.field_76652_q[var6].func_76660_i();
               if(var8 == null) {
                  var8 = this.field_76652_q[var6].func_76667_m();
               }

               System.arraycopy(p_76607_1_, var5, var8.field_76585_a, 0, var8.field_76585_a.length);
               var5 += var8.field_76585_a.length;
            }
         } else if(p_76607_4_ && this.field_76652_q[var6] != null && this.field_76652_q[var6].func_76660_i() != null) {
            this.field_76652_q[var6].func_76676_h();
         }
      }
      ...
      for(var6 = 0; var6 < this.field_76652_q.length; ++var6) {
         if(this.field_76652_q[var6] != null && (p_76607_2_ & 1 << var6) != 0) {
