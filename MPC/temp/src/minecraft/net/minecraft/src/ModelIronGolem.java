...
public class ModelIronGolem extends ModelBase {
   ...
   public ModelIronGolem(float p_i3131_1_, float p_i3131_2_) {
      ...
      this.field_78178_a.func_78793_a(0.0F, 0.0F + p_i3131_2_, -2.0F);
      this.field_78178_a.func_78784_a(0, 0).func_78790_a(-4.0F, -12.0F, -5.5F, 8, 10, 8, p_i3131_1_);
      this.field_78178_a.func_78784_a(24, 0).func_78790_a(-1.0F, -5.0F, -7.5F, 2, 4, 2, p_i3131_1_);
      this.field_78176_b = (new ModelRenderer(this)).func_78787_b(var3, var4);
      this.field_78176_b.func_78793_a(0.0F, 0.0F + p_i3131_2_, 0.0F);
      this.field_78176_b.func_78784_a(0, 40).func_78790_a(-9.0F, -2.0F, -6.0F, 18, 12, 11, p_i3131_1_);
      this.field_78176_b.func_78784_a(0, 70).func_78790_a(-4.5F, 10.0F, -3.0F, 9, 5, 6, p_i3131_1_ + 0.5F);
      this.field_78177_c = (new ModelRenderer(this)).func_78787_b(var3, var4);
      this.field_78177_c.func_78793_a(0.0F, -7.0F, 0.0F);
      this.field_78177_c.func_78784_a(60, 21).func_78790_a(-13.0F, -2.5F, -3.0F, 4, 30, 6, p_i3131_1_);
      this.field_78174_d = (new ModelRenderer(this)).func_78787_b(var3, var4);
      this.field_78174_d.func_78793_a(0.0F, -7.0F, 0.0F);
      this.field_78174_d.func_78784_a(60, 58).func_78790_a(9.0F, -2.5F, -3.0F, 4, 30, 6, p_i3131_1_);
      this.field_78175_e = (new ModelRenderer(this, 0, 22)).func_78787_b(var3, var4);
      this.field_78175_e.func_78793_a(-4.0F, 18.0F + p_i3131_2_, 0.0F);
      this.field_78175_e.func_78784_a(37, 0).func_78790_a(-3.5F, -3.0F, -3.0F, 6, 16, 5, p_i3131_1_);
      this.field_78173_f = (new ModelRenderer(this, 0, 22)).func_78787_b(var3, var4);
      this.field_78173_f.field_78809_i = true;
      this.field_78173_f.func_78784_a(60, 0).func_78793_a(5.0F, 18.0F + p_i3131_2_, 0.0F);
      this.field_78173_f.func_78790_a(-3.5F, -3.0F, -3.0F, 6, 16, 5, p_i3131_1_);
   }
