...
public class GuiMultiplayer extends GuiScreen {
   ...
   public void func_74016_g() {
      ...
      this.field_73887_h.add(this.field_74029_o = new GuiButton(7, this.field_73880_f / 2 - 154, this.field_73881_g - 28, 70, 20, var1.func_74805_b("selectServer.edit")));
      ...
      this.field_74029_o.field_73742_g = var2;
   ...
   private void func_74002_a(ServerData p_74002_1_) {
      this.field_73882_e.func_71373_a(new GuiConnecting(this.field_73882_e, p_74002_1_));
   }
      ...
      try {
         ...
         if(var5.startsWith("\u00a7") && var5.length() > 1) {
            ...
            if(MathHelper.func_82715_a(var26[0], 0) == 1) {
               ...
               if(var8 >= 0 && var9 >= 0) {
                  p_74017_1_.field_78846_c = "\u00a77" + var8 + "\u00a78/\u00a77" + var9;
               } else {
                  p_74017_1_.field_78846_c = "\u00a78???";
               }
            } else {
               p_74017_1_.field_82822_g = "???";
               p_74017_1_.field_78843_d = "\u00a78???";
               p_74017_1_.field_82821_f = 50;
               p_74017_1_.field_78846_c = "\u00a78???";
            }
         } else {
            var26 = var5.split("\u00a7");
            ...
            p_74017_1_.field_78843_d = "\u00a77" + var5;
            if(var8 >= 0 && var9 > 0) {
               p_74017_1_.field_78846_c = "\u00a77" + var8 + "\u00a78/\u00a77" + var9;
            } else {
               p_74017_1_.field_78846_c = "\u00a78???";
