...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(new GuiButton(0, this.field_73880_f / 2 - 100, this.field_73881_g / 4 + 96 + 12, var1.func_74805_b("gui.done")));
   ...
   protected void func_73869_a(char p_73869_1_, int p_73869_2_) {
      ...
      ((GuiButton)this.field_73887_h.get(0)).field_73742_g = this.field_82318_a.func_73781_b().trim().length() > 0;
      if(p_73869_1_ == 13) {
