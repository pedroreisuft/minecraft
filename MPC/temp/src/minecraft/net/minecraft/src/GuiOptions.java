...
public class GuiOptions extends GuiScreen {
   ...
   private static final EnumOptions[] field_74052_b = new EnumOptions[]{EnumOptions.MUSIC, EnumOptions.SOUND, EnumOptions.INVERT_MOUSE, EnumOptions.SENSITIVITY, EnumOptions.FOV, EnumOptions.DIFFICULTY};
   ...
   public void func_73866_w_() {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if(var6.func_74380_a()) {
            this.field_73887_h.add(new GuiSlider(var6.func_74381_c(), this.field_73880_f / 2 - 155 + var2 % 2 * 160, this.field_73881_g / 6 + 24 * (var2 >> 1), var6, this.field_74051_d.func_74297_c(var6), this.field_74051_d.func_74296_a(var6)));
         } else {
            GuiSmallButton var7 = new GuiSmallButton(var6.func_74381_c(), this.field_73880_f / 2 - 155 + var2 % 2 * 160, this.field_73881_g / 6 + 24 * (var2 >> 1), var6, this.field_74051_d.func_74297_c(var6));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_73873_v_();
      this.func_73732_a(this.field_73886_k, this.field_74054_a, this.field_73880_f / 2, 20, 16777215);
