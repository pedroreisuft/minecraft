...
public class ComponentStrongholdLibrary extends ComponentStronghold {
   ...
   public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
      if(this.func_74860_a(p_74875_1_, p_74875_3_)) {
         ...
         this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 3, 3, 5, field_75007_b, 1 + p_74875_2_.nextInt(4));
         if(this.field_75008_c) {
            this.func_74864_a(p_74875_1_, 0, 0, 12, 9, 1, p_74875_3_);
            this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 12, 8, 1, field_75007_b, 1 + p_74875_2_.nextInt(4));
         }
