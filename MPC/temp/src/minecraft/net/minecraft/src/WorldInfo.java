...
import net.minecraft.src.CallableLevelDimension;
import net.minecraft.src.CallableLevelGamemode;
import net.minecraft.src.CallableLevelGenerator;
import net.minecraft.src.CallableLevelGeneratorOptions;
import net.minecraft.src.CallableLevelSeed;
import net.minecraft.src.CallableLevelSpawnLocation;
import net.minecraft.src.CallableLevelStorageVersion;
import net.minecraft.src.CallableLevelTime;
import net.minecraft.src.CallableLevelWeather;
